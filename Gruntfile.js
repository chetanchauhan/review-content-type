...
module.exports = function (grunt) {
	...
	grunt.initConfig({
		...
		checktextdomain: {
			options: {
				text_domain: 'review-content-type',
				keywords: [
					'__:1,2d',
					'_e:1,2d',
					'_x:1,2c,3d',
		...
		makepot: {
			plugin: {
				options: {
					...
					exclude: ['build/.*'],
					mainFile: 'review-content-type.php',
					potFilename: 'review-content-type.pot',
					potHeaders: {
						poedit: true,
						'report-msgid-bugs-to': 'https://github.com/chetanchauhan/review-content-type/issues'
					}
				}
			}
		},
